...
public class CommonUtil {
    ...
    public static AccessToken getToken() {
        ...
        String requestUrl = "https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid="+ParameterUtil.WxConfig.APP_ID+"&secret="+ParameterUtil.WxConfig.APPSECRET;
